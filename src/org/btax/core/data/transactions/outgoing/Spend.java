...
public class Spend extends TransactionBase implements HasOutgoing, HasFee, HasGoodOrServicePriceInEUR, HandoverEvent {
    double outgoing;
    ...
    public Spend(CointrackingCSVRow row) throws ParseException {
    ...
    public Spend(double outgoing, String outgoingCurrency, double fee, String feeCurrency, double goodOrServicePriceInEUR, String exchange, String group, String comment, Date date, String recordString) {
