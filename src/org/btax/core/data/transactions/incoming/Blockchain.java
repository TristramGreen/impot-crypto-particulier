...
public class Blockchain extends TransactionBase implements HasIncoming, HasFee {
    double incoming;
    String incomingCurrency;
    double fee;
    String feeCurrency;

    public Blockchain(CointrackingCSVRow row) throws ParseException {
    ...
    public Blockchain(double incoming, String incomingCurrency, double fee, String feeCurrency, String exchange, String group, String comment, Date date, String recordString) {
